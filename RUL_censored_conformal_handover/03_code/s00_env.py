...
检查:
  1. Python 与 numpy / pandas / scikit-learn / matplotlib 版本
  2. 出图要用的字体文件是否存在 (宋体 simsun.ttc, Times New Roman times.ttf)
  3. 数据目录里 FD001 三个文件是否齐全
...
def main():
    ...
    print("[2] 字体文件 (s04 出图用; 缺宋体或 Times New Roman 则图不能用于论文)")
